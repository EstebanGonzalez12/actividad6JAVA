...
public class Main {
    ...
    public static double calcularSalarioDevengado(int salarioBase, int horasTrabajo, int horasExtras) {
        // Salario base por horas trabajadas
        double salarioPorHoras = (double) salarioBase / horasTrabajo;
        // Salario devengado considerando horas trabajadas y horas extras
        double salarioDevengado = (salarioPorHoras * horasTrabajo) + (salarioPorHoras * horasExtras * 1.5);
